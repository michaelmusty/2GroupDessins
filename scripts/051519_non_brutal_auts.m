...
s4 := LiftBelyiMap(s4, s2, f4 : brutal_auts := false);
/* s4 := LiftBelyiMap(s4, s2, f4 : brutal_auts := true); */
...
s8_1 := LiftBelyiMap(s8, s4, f8_1 : brutal_auts := false);
s8_2 := LiftBelyiMap(s8, s4, f8_2 : brutal_auts := false);
