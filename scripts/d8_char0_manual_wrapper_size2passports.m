...
printf "#candidates_galois (found over K galois over ext) = %o\n", #candidates_galois;
for i := 1 to #candidates_galois do
  printf "i=%o : %o\n", i, candidates_galois[i];
end for;
candidates_found_over_ext, auts_ext := GetCandidateFunctionsOverExtensionChar0(Kext, phi, ram, auts);
candidates_found_over_ext_galois := CheckIfGalois(candidates_found_over_ext, auts_ext);
for i := 1 to #candidates_galois do
  printf "i=%o : %o\n", i, candidates_galois[i];
end for;
